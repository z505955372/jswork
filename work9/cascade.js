...
function createOpetion(obj,data){
    for (var i in data){
        var op = new Option (data[i],i);
        obj.options.add(op);
    }
}
var collegeSelece= document.getElementById('collegeSelect');
createOpetion(collegeSelect,colleges);
...
collegeSelect.onchange = function() {
    ...
    createOpetion(majorSelect,majors[collegeSelect.value]);
...
majorSelect.onchange = function() {
    classSelect.options.length = 0;
    createOpetion(classSelect,classes[collegeSelect.value][ majorSelect.value])
}
